...
public class Main {
	...
	public static void main(String[] args) {
      ...
      try {
          Connection conn = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\Muzi\\Documents\\Database\\W3C\\W3clients.db");
          conn.setAutoCommit(true);
          Statement statement = conn.createStatement();
          statement.execute("CREATE TABLE IF NOT EXISTS W3clients " +
                            " (customer_ID INTEGER, customerName TEXT, Address TEXT, City TEXT, Country TEXT)");
          
          
			/*
			 * statement.
			 * execute("INSERT INTO W3clients (customer_ID, customerName, Address, City, Country) "
          ...
          statement.execute("SELECT * FROM W3clients");
